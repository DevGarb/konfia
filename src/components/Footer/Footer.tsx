...
const Footer = () => {
  ...
  <div className="mx-auto max-w-screen-xl text-center">
      ...
      <p className="my-6 text-gray-500 dark:text-gray-400">Uma nova experiência em Assistência Técnica!</p>
      <ul className="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
          <li>
              <a href="#" className="mr-4 hover:underline md:mr-6 ">Sobre nós</a>
          </li>
          <li>
              <a href="#" className="mr-4 hover:underline md:mr-6">Redes Sociais</a>
          </li>
          <li>
              <a href="#" className="mr-4 hover:underline md:mr-6 ">Localização</a>
          </li>
          <li>
      ...
      <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" className="hover:underline">KONFIA™</a>. All Rights Reserved.</span>
  </div>
</footer>
        </>
    )
