            ...
            <div className="flex items-center flex-wrap">
                <div className="mx-auto max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8">
                    <div className="max-w-2xl">
                        <h2 className="text-3xl font-bold tracking-tight mt-7 mb-14 text-gray-900 sm:text-4xl">
                        ...
                        <h6 className="my-6 text-justify text-lg leading-8 font-semibold text-gray-500 lg:text-xl dark:text-gray-400 bg-slate-200 max-lg:w-screen px-4">
                            <p>
